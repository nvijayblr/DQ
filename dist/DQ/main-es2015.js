...
/* harmony import */ var _components_login_signup_login_login_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/login-signup/login/login.component */ "./src/app/components/login-signup/login/login.component.ts");
/* harmony import */ var _components_login_signup_signup_signup_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/login-signup/signup/signup.component */ "./src/app/components/login-signup/signup/signup.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["NgModule"])({
        declarations: [
            ...
            _components_login_signup_login_login_component__WEBPACK_IMPORTED_MODULE_14__["LoginComponent"],
            _components_login_signup_signup_signup_component__WEBPACK_IMPORTED_MODULE_15__["SignupComponent"]
        ],
        imports: [
        ...
        providers: [
            _services_http_service_service__WEBPACK_IMPORTED_MODULE_8__["HttpService"],
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HTTP_INTERCEPTORS"], useClass: _services_http_interceptor_service__WEBPACK_IMPORTED_MODULE_11__["HttpInterceptorService"], multi: true },
            _services_auth_guard_service__WEBPACK_IMPORTED_MODULE_9__["AuthGuardService"],
...
let HttpService = class HttpService {
    ...
    makeNotificationRead(userId, notificationId) {
        return this.http.put(`${this.rootUrl}user/${userId}/notifications/${notificationId}/status?status=true`, {}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((res) => {
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(err => {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(err);
        }));
    }
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('owlCatCar', { static: false })
...
let HeaderComponent = class HeaderComponent {
    ...
    makeNotificationRead(notification) {
        ...
        if (!notification.status) {
            this.http.makeNotificationRead(this.userId, notification.id).subscribe((result) => {
                this.isLoading = false;
...
module.exports = __webpack_require__(/*! /Users/vijay/Desktop/workspace/DQ/src/main.ts */"./src/main.ts");
