  ...
  function srcAppComponentsAuthorizedRulesetRulesetComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var RulesetComponent = /*#__PURE__*/function () {
      ...
      _createClass(RulesetComponent, [{
        ...
        key: "getMinVal",
        value: function getMinVal(ruleVal) {
        ...
        key: "getFormulaText",
        value: function getFormulaText(formulas, type) {
          var formulaText = '';
          ...
          if (formulas && Array.isArray(formulas)) {
            formulas.map(function (formula) {
              switch (type) {
                ...
                case 'ADVANCED':
                  formulaText += formula.start + formula.cde1 + formula.operator1 + formula.cde2 + formula.value + formula.end + formula.condition + formula.operator2;
                  break;
        ...
        key: "openFormulaEditor",
        value: function openFormulaEditor(rule) {
          var type = rule.controls.type.value;
